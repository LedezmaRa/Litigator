...
You have been provided with data detailing the top macro drivers for 11 S&P sectors, including their short-term trends, 1-month changes, and 90-day correlations to each sector's ETF.

Your task:
1. Review the provided macro drivers and correlation data across all sectors.
2. Provide a comprehensive, multi-paragraph state-of-the-market executive summary. Start from first principles — what does the rate regime, commodity signals, currency dynamics, and credit conditions collectively tell us about where we are in the economic cycle? Explain the mechanisms clearly for a non-expert reader. What is the dominant narrative the data is telling us?
...
def generate_macro_investment_memo(drivers_data: dict, output_dir: str = "reports"):
    ...
    prompt_data = json.dumps(drivers_data, indent=2)
        ...
        <body>
            ...
            <div class="container">
                <header style="text-align: center; margin-bottom: 3rem;">
                    ...
                    <p class="text-muted">Generated by "Joe" | Powered by Anthropic Claude Opus</p>
                </header>
